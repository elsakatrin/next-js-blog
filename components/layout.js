  ...
  return (
    <div className={styles.container}>
      ...
      <Head>
        ...
        {/* This is a meta tag that is used to provide structured metadata about a webpage. This can be used for search engines to help catagorixe the page correctly */}
        <meta
          name="description"
