...
//Feching external data from filesystem and this page is prerendered with that data
//getStaticProps can only be exported from a 'page' file not none page files
//Returning allPostsData into the props object in getStaticProps the blogpost will be passed to the Home components as a prop
    ...
    <Layout home>
      <Head>
        ...
        <section className={utilStyles.headingMd}>
          ...
          {/* The Link component enables client-side navigation between two pages in nextjs. Client-side navigation means that the page trasition happens using javascript which isfaster than the default navigation done by the browser */}
          ...
          <p>Hello, my name is Elsa and I'm studying web developement at Vefskólinn. I followed a {' '}
